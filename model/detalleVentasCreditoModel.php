<?php
class detalleVentasCredito{
	static $tabla="detalleVentasCredito";
	static $idTabla="iddetalleVentasCredito";
	static $objeto;
	static $consulta;
	...
	public  $precio_total;
	public  $precio_unit;
	public  $ventascredito_idventascredito;
	...
	function __construct(){
	 ...
	 public function   listarTodos(){
			 ...
			 public function getDetalle($id){
					 ...
					 global $db;
				$sql="SELECT * FROM ".self::$tabla." WHERE ventascredito_idventascredito='".$id."' ORDER BY codigo";
				$res=$db->query($sql)->fetchAll();
				return ($res);
					}
