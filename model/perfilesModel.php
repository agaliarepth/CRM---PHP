...
class Perfiles{
	...
	static $idTabla="idperfiles";
	static $objeto;
	
	public  $descrip;
	public  $modulo_catalogo;
	public  $modulo_almacenes;
	public  $modulo_proveedores;
	public  $modulo_clientes;
	public  $modulo_administracion;
	public  $modulo_ventas;
	public  $modulo_compras;
	public  $modulo_cobranzas;
		...
		public function get_objeto(){
			...
			public function borrar($id){
	         ...
	         public   function getId($id){
				...
				global $db;
				$sql="SELECT descrip FROM ".self::$tabla." WHERE ".self::$idTabla."='".$id."'";
				$res=$db->query($sql)->fetch(PDO::FETCH_ASSOC);
				return ($res);
				...
				$sql="SELECT idperfiles,  descrip FROM ".self::$tabla." ORDER BY idperfiles ASC";	
				$res=$db->query($sql)->fetchALL();
				return $res;
