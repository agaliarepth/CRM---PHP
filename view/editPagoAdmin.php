...
<div id="main_content">
        ...
        <div id="contact_area">
            ...
            <div class="container">
                 ...
                 <h2 id="contact">COBRANZAS > EDITAR  PAGO CUOTA ADMIN</h2>
            <div>
           <TABLE border="1">
          ...
          <td><?php echo date("d-m-Y",strtotime($fecha));?></td>
           ...
           <td><?php echo $res2["saldo_actual"]+$res4["monto"]?></td>
           ...
           <form action="" method="post"  class="notas" name="form" id="wizard">
            ...
            <td><label>Numero de Pago</label><input value="<?php echo $res["numpago"]?>" type="text" name="numpago"   readonly="readonly" size="3"id="numpago" />
               ...
               <td><label>Saldo Actual</label><input value="<?php echo $res["saldo_actual"]+$res4["monto"]?>" type="text" name="saldo_actual"   readonly="readonly" size="10"id="saldo_actual" />
 ...
 <input type="hidden" name="monto_ant" id="monto_ant"   value="<?php echo $res4["monto"]?>"/>
