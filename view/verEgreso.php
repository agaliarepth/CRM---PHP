...
<input type="hidden" id="numero" name="numero" value="<?php echo $res["idegreso"];  ?>" />
<input type="hidden" id="fecha" name="fecha" />
<input type="hidden" id="tipo" name="tipo" value="verNotaEgreso" />
...
<table width="650" border="0" align="center" style="font-family:calibri; font-size:10px; ">
  ...
  <tr>
    <td colspan="4" align="center" ><span style="font-size:18px; font-family:calibri; font-weight:bold; text-decoration:underline;  margin-left:130px;"> NOTA DE EGRESO</span></td>
    <td width="76"  ></td>
  ...
  <tr>
    <td colspan="2"  class="negrita">ENVIA : <?php echo $res["envia"]; ?> </td>
    <td colspan="3"  class="negrita">RECIBE : <?php   echo $res["recibe"]; ?>        </td>
    <td width="113"  class="negrita">FECHA:<?php echo date("d/m/Y",strtotime($res["fecha"]));  ?></td>
    </tr>
  <tr>
    <td width="59" class="negrita">DESTINO:</td>
    <td width="138" class="negrita"> <?php echo $res["destino"]; ?></td>
    <td colspan="4" class="negrita">CONCEPTO: <?php echo $res["concepto"]; ?></td>
    </tr>
</table>
</td>
</tr>
...
<thead>
  <tr>
    ...
    <td align="center" width="33" class="negrita">N&deg;</td>
  ...
  <tr align="center">
    ...
    <td align="right"><?php echo $v["precio_unitario"];?></td>
  ...
  <tfoot>
  <tr align="center">
    <td  style="font-weight:bold; background-color:#EFEFEF;"align="right"  colspan="4" class="negrita"><span class="negrita" style="font-weight:bold; background-color:#EFEFEF;">CANTIDAD :</span></td>
    <td><span style="font-weight:bold; background-color:#EFEFEF;"><span class="negrita"><?php echo $res["cant_total"]; ?></span></span></td>
    <td  align="right" style="font-weight:bold; background-color:#EFEFEF;" class="negrita">P.TOTAL :</td>
    <td  align="right"class="negrita" style="font-weight:bold; background-color:#EFEFEF;"><?php echo $res["precio_total"]; ?></td>
    <TD></TD>
    </tr>
  </tfoot>
</table>
