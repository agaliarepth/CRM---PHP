...
<table width="650" border="0" align="center" style="font-family:calibri; font-size:10px; ">
  <tr>
    <td colspan="4"><img  style="float:left" src="<?php echo config::ruta();?>images/logo2.png" width="90" height="51"/>
      ...
      <tr>
        <td width="358" align="center"><strong>VISUAL EDICIONES S.R.L</strong>
  ...
  <tr>
    ...
    <td colspan="1" class="negrita"><?php if($res["tipoventa"]=="CREDITO"){?>CONDICIONES PAGO : <?php if($res3["dias"]>0) { echo $res3["dias"]." DIAS DE GRACIA ";} echo $res3["diaspago"];?> DIAS DE PAGO<?php }if($res["tipoventa"]=="CONTADO"){?>RI: <?php  echo $res4["numingreso"];?>
  
    </td>
      <TD class="negrita">FAC:<?PHP echo $res4["numfactura"];  ?></TD>
      <?php }?>
    </tr>
...
<td colspan="1" width="50%" >
 ...
 <td  align="right"colspan="2" style="font-size:7px; font-weight:bold; font-style:italic;">Observaciones:<?php echo $res["obs"]?></td>
