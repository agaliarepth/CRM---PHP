...
<input type="hidden" id="tipo" name="tipo" value="verNotaIngreso" />
...
<table width="650" border="0" align="center" style="font-family:calibri; font-size:10px; ">
  ...
  <tr>
    <td colspan="4" align="center" ><span style="font-size:18px; font-family:calibri; font-weight:bold; text-decoration:underline;  margin-left:130px;"> NOTA DE INGRESO</span></p></td>
    <td width="76"  ></td>
    <td align="center" width="100"  style=" border:groove;"><span   style="font-size:18px; font-weight:bold;">N&ordm;: <?php echo Helpers::rellenarCeros($res["idingreso"],6); ?></span></td>
  </tr>
  </table>
  ...
  <tr>
    ...
    <td width="138"  class="negrita"> <?php echo $res["recibe"]; ?></td>
  ...
  <tr>
    ...
    <td class="negrita"> <?php echo $res["documento"]; ?></td>
...
<thead>
  ...
  <tr >
    ...
    <td align="center"><?php echo $det["tomo"];?></td>
     <td align="center"><?php echo $v["cantidad"];?></td>
    <td align="right"><?php echo number_format($v["precio_unitario"], 2, ',', '.');?></td>
  ...
  <tfoot>
  <tr align="">
    <td  style="font-weight:bold; background-color:#EFEFEF;"align="right"  colspan="4" class="negrita">C/TOTAL</td>
    <td align="center"><span class="negrita" style="font-weight:bold; background-color:#EFEFEF;"><?php echo $res["cant_total"]; ?></span></td>
    <td  align="right" style="font-weight:bold; background-color:#EFEFEF;" class="negrita">P/TOTAL :</td>
    <td  align="right"class="negrita" style="font-weight:bold; background-color:#EFEFEF;"><?php echo number_format($res["precio_total"], 2, ',', '.'); ?></td>
