...
$("#num_filas").val(nextinput);
   ...
   {
    campo = '<tr aling ="center"><td><input type="text" class="inp2-form" readonly ="readonly" size="5" id="cantidad' + nextinput + '"  name="cantidad[]' + nextinput + '"  value="     '+cantidad+'"/></td><td width="10px"><input type="text" class="inp2-form" readonly ="readonly" size="10" id="codigo' + nextinput + '"  name="codigo[]' + nextinput + '"       value="'+codigo+'"  /></td><td><input type="text" class="inp4-form" readonly ="readonly"  size="70" id="titulo ' + nextinput + '"  name="titulo[]' + nextinput + '" value="'+titulo+'"  /></td><td><input type="text" class="inp2-form"  readonly ="readonly" size="5" id="tomo' + nextinput + '"  name="tomo[]' + nextinput + '" value="'+tomo+'" /></td><td><input type="text" class="inp2-form" readonly ="readonly" size="10" value="'+pu+'" id="precio_unit' + nextinput + '"  name="precio_unit[]"  /></td><td colspan="2"><input type="text" class="inp2-form" readonly ="readonly" size="10" id="precio_total' + nextinput + '" value="'+pt+'"  name="precio_total[]' + nextinput + '"/></td><td><input type="hidden"  id="idlibro' + nextinput + '"  name="idlibro[]' + nextinput + '" value="'+id+'"  /></td><td><img src="images/eliminar.png  " width="25" height="25" alt="Eliminar"  id="boton' + nextinput + '" onclick="if(confirm(\'Realmente desea eliminar este detalle?\')){eliminarFila(this); }"/></td></tr>';
...
<div id="main_content">
        ...
        <div id="contact_area">
         ...
         <h2 id="contact">CENTAS> EDITAR VENTA CREDITO</h2>
            <div>
   ...
   <input name="monto_total" size="5"  class="inp2-form" readonly  id="monto_total" /></td>
	...
	<thead>
        ...
        <td>
          ...
          <input type="text"  id="telf" name="telf" size="12"/>
           </td>
       ...
       <td >
        ...
        <select  class="inp-form" name="vendedor" id="vendedor">
         <option  value="Wendy">wendy
        </option>
			  <option value="javier">JAVIER MERUBIA</option>
                                    
			
		</select></td>
        <td><label>FECHA VENTA</label><input type="text" id="fecha" name="fecha" class="fechas" value="<?php echo date("Y-m-d");?>"/></td>
        <td >
               <label>MONEDA</label>
        ...
        <td >
               <label>CAMBIO</label>
<input type="text" name="cambio" id="cambio" size="10" />
        </td>
...
<table cellpadding="0"  width="70%" id="detalle" border="0">
   ...
   <input name="monto_total" size="5"  class="inp2-form" readonly  id="monto_total" /></td>
                     ...
                     <fieldset><legend>CONDICIONES DE  CREDITO</legend>
                     <table>
                     <TR>
                     <TD><label>Dias de Pago</label>
                     <select name="num_cuotas" >
                     <option value="1">30 dias</option>
                     <option value="1">45 dias</option>
                     ...
                     <fieldset><legend>DESCUENTO</legend>
                     <table>
                     <TR>
                     <TD><label>Dias de Pago</label>
                     <select name="num_cuotas" >
