...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <td><label>NUMERO DE FACTURA</label>
                     <input type="TEXT" name="facturaadelanto" id="facturaadelanto" style="text-transform:uppercase;" value="<?php echo $credito["facturaadelanto"]?>"/>
                     </td>
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="reciboadelanto" id="reciboadelanto" style="text-transform:uppercase;" value="<?php echo $credito["reciboadelanto"]?>"/>
                     </td>
...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <fieldset id="tablaadelanto" style="display:none;"><legend>ADELANTO</legend>
                     <table  >
                     <TR>
                     <TD>
                     <label>MONTO</label>
           ...
           <fieldset id="tablacondiciones" style="display:none;"><legend>CONDICIONES DE  CREDITO</legend>
                   ...
                   <!--  <td>
                     <label>Fecha del Primer Pago</label>
                     <input  type="text" name="primerpago" id="fecha2" class="fechas"  readonly="readonly"size="10" value="<?php echo date("d-m-Y")?>"/>
                     </td>-->
                      <td>
                     <input  type="button" value="Ver Plan de Pagos"  id="btn_cuotas" name="btn_cuotas" onclick="verPlanPagos();" />
                     </td>
                     </TR>
