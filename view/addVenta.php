 ...
 <script type="text/javascript">
  ...
  return $( "<li>" )
    ...
    .appendTo( ul );
		...
		function clienteSeleccionado(event, ui)
		{
			...
			$( "#nombrefactura" ).val( ui.item.razonsocial );
		...
		function productoSeleccionado1(event, ui)
		{
		 ...
		 function getDevolucion(){
			 ...
			 if(idcliente==0 || idcliente==''){
				 alert("ERROR::NO SE AGREGO NINGUN CLIENTE A  LA VENTA");
				 $("#nombre").focus();
			   ...
			   $.ajax({
                              ...
                              type: "POST",
                              url: "ajax/BuscarDevolucionCliente.php?idcliente="+idcliente,
                              data: "id="+id,
                              dataType: "json",
                              error: function(){
                              ...
                              success: function(data){
								    ...
								    if(data!=false){
                                          ...
                                          $("#fechadevolucion").val(data.fecha);
										  $("#saldodevolucion").val(data.saldo);
										 
											
										}
										
									else  {
										 alert("LA NOTA DE INGRESO NUM: " +$("#iddevolucion").val() +":: NO SE  ENCUENTRA REGISTRADO o NO ESTA PROCESADA PARA ESTE CLIENTE...");
										 }
									  n();
  ...
  $(document).ready(function($)
  {
	...
	addTableRow($("#codigoLabel").val(),$( "#cantidad" ).val(),$( "#libro" ).val() , tomo, $( "#pu" ).val(),pt,id, $( "#stock" ).val());
	 ...
	 $("#montodevolucion").change(function(){
		   if(!$("#montodevolucion").val().match(/^(\d{1}\.)?(\d+\.?)+(,\d{2})?$/)){
			 ...
			 $("#montodevolucion").focus();
			  ...
			  $("#adelanto").val("0");
				   ...
				   if(parseFloat($(this).val())>parseFloat($("#saldodevolucion").val())){
					   alert("ERROR:: EL, MONTO DE  ADELANTO NO PUEDE SER MAYOR AL SALDO DE LA DEVOLUCION");
					   
					    $("#montodevolucion").val("0");
			           $("#montodevolucion").focus();
					   }
				   $("#adelanto").val($("#montodevolucion").val());
				  // alert($("#adelanto").val());
				   }
	 });
			     
	    $("#iddevolucion").change(function(){
			getDevolucion();
			
			});
	  
	  
	     $("#tipoadelanto").change(function(){
		   if($(this).val()=="devolucion"){
			 $("#adelanto_devolucion").css({ display: "block"});
			 $("#adelanto_contado").css({ display: "none"});
			 
			   }
			   else{
				   
				    $("#adelanto_devolucion").css({ display: "none"});
			 $("#adelanto_contado").css({ display: "block"});
				   }
	   ...
	   $("#diaspago").change(function(){
		   ...
		   if(parseFloat($("#adelanto").val())>precio_total){
			 alert("ERROR::EL MONTO DEL ADELANTO NO PUEDE SER MAYOR AL MONTO DE LA VENTA");
			 $("#adelanto").val(0);
			 $("#adelanto").focus();
			   }
	...
	<?php 
if(isset($_GET["e"])&& $_GET["e"]=="evadmin"){

  foreach($res2 as $v){
	  $s=$li->getStock($v["libros_idlibros"]);
	  echo "addTableRow2('".$v["codigo"]."',$v[cantidad],'".$v["titulo"]."','".$v["volumen"]."',$v[precio_unit],$v[precio_total],$v[libros_idlibros],$s);";
...
if(isset($_GET["e"])&& $_GET["e"]=="ev"){
  ...
  foreach($res2 as $v){
	  $s=$li->getStock($v["libros_idlibros"]);
	  echo "addTableRow('".$v["codigo"]."',$v[cantidad],'".$v["titulo"]."','".$v["volumen"]."',$v[precio_unit],$v[precio_total],$v[libros_idlibros],$s);";
...
?>
   ...
   function addTableRow( codigo,cantidad, titulo, tomo,pu,pt,id,disponible)
   {
    campo = '<tr ><td width="10px"><input style="text-align:center" type="text"  readonly ="readonly" size="10" id="codigo' + nextinput + '"  name="codigo[]' + nextinput + '" value="'+codigo+'"  /></td><td><input  style="text-align:left"type="text"  readonly ="readonly"  size="70" id="titulo ' + nextinput + '"  name="titulo[]' + nextinput + '" value="'+titulo+'"  /></td><td><input style="text-align:center"type="text"  readonly ="readonly" size="5" id="tomo' + nextinput + '"  name="tomo[]' + nextinput + '" value="'+tomo+'" /></td><td ><input style="text-align:right" type="text"  size="5" id="cantidad' + nextinput + '"  name="cantidad[]' + nextinput + '"  value="'+cantidad+'" onchange="recalcularCantidad(this);" /></td><td  colspan="2"><input style="text-align:right" type="text" size="10" value="'+pu+'" id="precio_unit' + nextinput + '"  name="precio_unit[]" onchange="recalcularPrecio(this);"  /></td><td  ><input style="text-align:right" type="text"  readonly ="readonly" size="10" id="precio_total' + nextinput + '" value="'+pt+'"  name="precio_total[]' + nextinput + '"/></td><td><img src="images/eliminar.png  " width="25" height="25" alt="Eliminar"  id="boton' + nextinput + '" onclick="if(confirm(\'Realmente desea eliminar este detalle?\')){eliminarFila(this); }"/><input type="hidden"  id="idlibro' + nextinput + '"  name="idlibro[]' + nextinput + '" value="'+id+'"  /><input type="hidden"  id="disponible' + nextinput + '"  name="disponible[]' + nextinput + '" value="'+disponible+'"  /></td></tr>';
...
verPlanPagos();
   ...
   function addTableRow2( codigo,cantidad, titulo, tomo,pu,pt,id,disponible)
   {
    campo = '<tr ><td width="10px"><input style="text-align:center" type="text"  readonly ="readonly" size="10" id="codigo' + nextinput + '"  name="codigo[]' + nextinput + '" value="'+codigo+'"  /></td><td><input  style="text-align:left"type="text"  readonly ="readonly"  size="70" id="titulo ' + nextinput + '"  name="titulo[]' + nextinput + '" value="'+titulo+'"  /></td><td><input style="text-align:center"type="text"  readonly ="readonly" size="5" id="tomo' + nextinput + '"  name="tomo[]' + nextinput + '" value="'+tomo+'" /></td><td ><input style="text-align:right" type="text"  size="5" id="cantidad' + nextinput + '"    readonly ="readonly" name="cantidad[]' + nextinput + '"  value="'+cantidad+'" onchange="recalcularCantidad(this);" /></td><td  colspan="2"><input style="text-align:right" type="text" size="10" value="'+pu+'" id="precio_unit' + nextinput + '"  name="precio_unit[]" onchange="recalcularPrecio(this);"  /></td><td  ><input style="text-align:right" type="text"  readonly ="readonly" size="10" id="precio_total' + nextinput + '" value="'+pt+'"  name="precio_total[]' + nextinput + '"/></td><td><input type="hidden"  id="idlibro' + nextinput + '"  name="idlibro[]' + nextinput + '" value="'+id+'"  /><input type="hidden"  id="disponible' + nextinput + '"  name="disponible[]' + nextinput + '" value="'+disponible+'"  /></td></tr>';
	if(typeof(codigo)=="undefined"){
	alert("ERROR::Este codigo de libro No se Encuentra Registrado En El Catalogo");
	return;
	}
...
return true;
		   ...
		   function validarEnviar(){
				...
				if(nextinput==0){
					...
					if($("#idclientes").val()==""){
						...
						if($("#numingreso").val()==""&&$("#tipo").val()=="contado"){
							
							alert("ERROR: DEBE INGRESAR EL  RECIBO DE INGRESO");
							$("#numingreso").focus();
							$("#numingreso").css("background-color",'#F445566');
							return;
 ...
 function verPlanPagos(){
	 ...
	 */
	  ...
	  $.ajax({
                              ...
                              success: function(data){
										...
										addRowCuotas(data[i].numcuota,data[i].fecha,data[i].monto,data[i].monto,data[i].monto);
  ...
  function addRowCuotas(cuota,fecha,saldo,monto,monto_ant){
	  
f="<tr><td><input type='text' size=5 name='numcuota[]' value='"+cuota+"'></td><td><input type='text' size=10 name='fechacuota[]' value='"+fecha+"'></td><td><input type='text' size=8 name='saldocuota[]'  readonly id='saldocuota"+i+"' value='"+monto+"'></td><td><input type='text' size=8 name='montocuota[]' onchange='recalcularMontoCuota(this);' id='montocuota"+i+"' value='"+monto+"'></td> <input type='hidden' name='ant[]' value='"+monto+"'/ ></tr>";
 ...
 function recalcularMontoCuota(c){
	 ...
	 if(resultado!=false){
		...
		$("#"+c.id).parent().parent().find("input").eq(1).val($("#"+c.id).parent().parent().find("input").eq(2).val());
...
<div id="main_content">
        ...
        <div id="contact_area">
            ...
            <?php if (isset($_GET["e"])&&($_GET["e"]=="ev"||$_GET["e"]=="evadmin")){?>
	...
	<thead>
		...
		<input    type="text" id="nombre" name="nombre" size="35" value="<?php echo $res["nombre"]?>"/>
        ...
        <td>
          ...
          <input type="text"  id="razonsocial" name="razonsocial" size="35"  style="text-transform:uppercase;" value="<?php echo $res["razonsocial"]?>"/>
           </td>
           <td>
                 <label>NIT/CI</label>

          <input type="text"  id="nit" name="nit" size="10" value="<?php echo $res["nit"]?>"/>
           </td>
           <td>
                 <label>PAIS</label>

          <input type="text"  size="12"  name="pais" id="pais" value="<?php echo $res["pais"]?>"/>
           </td>
           <td>
                 <label>CIUDAD</label>

          <input type="text" size="15"  id="ciudad" name="ciudad" value="<?php echo $res["ciudad"]?>"/>
           </td>
            <td>
                 <label>LOCALIDAD</label>

          <input type="text"  size="15" id="localidad" name="localidad" value="<?php echo $res["localidad"]?>"/>
           </td>
           <td>
                 <label>TELEFONO</label>

          <input type="text"  id="telf" name="telf" size="10" value="<?php echo $res["telf"]?>"/>
           </td>
  ...
  <?php if (isset($_GET["e"]) && $_GET["e"]=="evadmin"){?>
  
   <input type="text"   class="inp-form" name="tipo" id="tipo" style=" background:#333; font-size:14px; height:22px; color:#FF0; width:150px; font-style:italic; font-weight:bolder;"  value="<?php echo $res["tipoventa"]?>">
  <?php } else{?>
        <select   class="inp-form" name="tipo" id="tipo" style=" background:#333; font-size:14px; height:22px; color:#FF0; width:150px; font-style:italic; font-weight:bolder;" >
        ...
        <td><label>DESTINO</label><input type="text" id="destino" name="destino"  style="text-transform:uppercase;" value="<?php echo $res["destino"]?>" /></td>
        <td >
        <td >
               <label>MONEDA</label>
...
<input type="text" name="cambio" id="cambio" size="10"  value="<?php echo $tc2["valor"];?>"/>
           ...
           <fieldset  <?php if (isset($_GET["e"]) && $_GET["e"]=="evadmin"){?> style="display:none;"<?php }?> ><legend>Items</legend>
...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <TD colspan="2"></TD>
                        <td > <input style="text-align:right"name="monto_total" size="10"  class="inp2-form" readonly  id="monto_total" /></td>
                     ...
                     <input type="TEXT" name="numfactura" style="text-transform:uppercase;" value="<?php echo $cont["numfactura"]?>" />
                     </td>
                       <td><label>RAZON SOCIAL</label>
                     <input type="TEXT" name="nombrefactura"  id="nombrefactura" style="text-transform:uppercase;"value="<?php echo $cont["razonsocial"]?>"/>
                     </td>
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="numingreso" id="numingreso" style="text-transform:uppercase;" value="<?php echo $cont["numingreso"]?>"/>
                     </td>
                     <td>
                     <label>MONTO INGRESO</label>
                     <input type="TEXT"   style="text-transform:uppercase;"value="<?php echo $cont["monto"]?>"name="montoingreso" class="validate[custom[number]]"/>
                     </td>
                     <td>
                     ...
                     <input type="TEXT" name="cuentabanco"   size="50" value="<?php echo $cont["cuentabanco"];?>"id="cuentabanco" style="text-transform:uppercase; " />
                     </td>
                     </TR>
                     
                     </table>
                     </fieldset>
                     <fieldset ><legend><input type="checkbox"  value="0"  id="tieneadelanto"/> ADELANTO</legend>
                      <table id="tablaadelanto" style="display:none">
                      <tr>
                      <td>
                     <select style="background-color:#333; color:#FF0; font-weight:bold" name="tipoadelanto" id="tipoadelanto">
                     <option value="dinero">CONTADO / DEPOSITO</option>
                     <option value="devolucion">DEVOLUCION VENTA</option>
                     
                     </select>
                     <table  id="adelanto_contado" >
                     <TR>
                     <TD>
                     <label>MONTO</label>
                     <input type="text"  name="adelanto" id="adelanto"  value="<?php echo $credito["adelanto"]?>"/>
                     ...
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="reciboadelanto" style="text-transform:uppercase;" value="<?php echo $credito["reciboadelanto"]?>"/>
                     </td>
                    ...
                    <select name="tipoadelanto" id="tipoadelanto">
                     ...
                     <td>
                     <label>BANCO-NUMERO DE CUENTA</label>
                     <input type="TEXT" name="cuentabancoadelanto"  size="50" id="cuentabancoadelanto" value="<?php echo $credito["cuentabanco"]?>"  />
                     </td>
                     ...
                     <tr>
                     <td>
                     <table id="adelanto_devolucion" style="display:none">
                     <tr>
                     <td>
                     <label>NOTA DE INGRESO</label><input type="text" id="iddevolucion" name="iddevolucion" size="15" />
                     </td>
                     <td>
                     <label>FECHA DEVOLUCION</label><input type="text" id="fechadevolucion" name="fechadevolucion" size="15" readonly /></td>
                     <td>
                     <label>SALDO</label><input type="text" id="saldodevolucion" name="saldodevolucion" size="15" readonly /></td>
                     <td>
                     <label>MONTO </label><input type="text" id="montodevolucion" name="montodevolucion" size="15" value="0" />
                     </td>
                     </tr>
                     ...
                     <table>
                     <TR>
                     <TD><label>Num.Cuotas</label><input  type="text" size="7" value="<?php echo $credito["num_cuotas"];?>" id="num_cuotas" name="num_cuotas"/>
                     
                     </TD>
                     <td><label>Dias de Pago</label>
                     <input type="text"  value="<?php echo $credito["diaspago"];?>" size="7"id="diaspago" name="diaspago"/>
                    
                     
                     </td>
                     <td><label>Dias de Gracia</label>
                     <input type="text"  value="<?php echo $credito["dias"];?>" size="7"id="dias" name="dias"/>
                    
                     
                     </td>
                     <!--<td>
                     <label>Fecha del Primer Pago</label>
                     <input  type="text" name="primerpago" id="fecha2" class="fechas"  readonly="readonly"size="10" value="<?php echo date("d-m-Y",strtotime($credito["fechaprimerpago"]));  ?>"/>
                     </td>-->
                     
                     <td>
                     <input  type="button" value="Plan de Pagos"   name="btn_cuotas" id="bconsultar"onclick="verPlanPagos();" />
                            ...
                            <td>NUM PAGO</td><td>FECHA VENCIMIENTO</td><td>SALDO</td><TD>MONTO CUOTA</TD>
                            </tr>
                            </thead>
                            <tbody id="campoCuotas">
                            <?php
							$cont=0;
							 foreach($listaCuotas as $r){ $cont++;?>
		                    <tr>
                            <td><input type='text' size=5 name='numcuota[]' value='<?php echo $r["numpago"]?>'></td>
                            <td><input type='text' size=10 name='fechacuota[]' value='<?php echo $r["fecha"]?>'></td>
                            <td><input type='text' size=8 name='saldocuota[]'  readonly id='saldocuota"+i+"' value='<?php echo $r["saldo_actual"]?>'></td>
                            <td><input type='text' size=8 name='montocuota[]' onchange='recalcularMontoCuota(this);' id='montocuota"+i+"' value='<?php echo $r["saldo_inicial"]?>'></td>
                             <input type='hidden' name='ant[]' value='<?php echo $r["saldo_actual"]?>'/ >
                             </tr>
							 ...
							 ?>
                             <input type="hidden" name="numfilascuotas" id="numfilascuotas" value="<?php echo $cont; ?>" />
                            </tbody>
                            </table>
                            </TD>
                     ...
                     <input type="text"  readonly="readonly" id="totalventa"  value="<?php echo $credito["saldo_inicial"]?>" />
                     ...
                     <input  type="text" id="descuentomonto" name="monto_descuento" value="<?php  echo $res["monto_descuento"]?>"/>
                     </td>
                     <td>
                     <label>Total   a cancelar</label>
                     <input  readonly="readonly"type="text" id="totalcancelar" name="totalcancelar" value="<?php echo $res["total_cancelar"]?>" />
                     </td>
                     </TR>
                     ...
                     <input type="text"  name="transporte" size="55" value="<?php echo $res["transporte"];?>"/>
                     
                    
                     </TD>
                      <td><label>OBSERVACIONES</label><textarea name="obs" cols="35" maxlength="255" id="obs" ><?php echo $res["obs"]?></textarea></td>
                     </TR>
...
-->
            <input type="button" id="cancelar" value="Cancelar"  name="cancelar"  onclick="javascript:window.location='<?php config::ruta()?>?accion=ventasCredito';"/>
               ...
               <?php if (isset($_GET["e"]) && $_GET["e"]=="evadmin"){?>
			    <input type="hidden" name="editAdmin" id="editAdmin" value="editAdmin" />
			     <input type="hidden" name="idegreso" value="<?php echo $res["idegreso"]; ?>"/>
			   <?php }?>
</td>
</tr>
               </table>
            ...
            <?php } else {?>
             ...
             <h2 id="contact">VENTAS > REGISTRAR VENTA </h2>
            <div>
             <form method="post"   class="notas"  action="" name="form" id="wizard"  >
       <fieldset ><legend>DATOS DEL CLIENTE</legend>
		<table border="0" cellpadding="0"  id="id-form" width="70%" >
	...
	<thead>
        ...
        <td>
          ...
          <input type="text"  id="nit" name="nit" size="10"/>
           </td>
           <td>
                 <label>PAIS</label>

          <input type="text"  size="12" name="pais" id="pais"/>
           </td>
           <td>
                 <label>CIUDAD</label>

          <input type="text"   size="15"id="ciudad" name="ciudad"/>
           </td>
            <td>
                 <label>LOCALIDAD</label>

          <input type="text"  id="localidad"  size="15"name="localidad" value=""/>
           </td>
           <td>
                 <label>TELEFONO</label>

          <input type="text"  size="10" id="telf" name="telf" />
           </td>
      ...
      <select name="vendedor">
			 ...
			 <option value="<?php echo $res9["idvendedores"]."||".$res9["nombres"];?>"><?php  echo $res9["nombres"];?></option>
			 <?php }?>  
               </select>
        <td><label>FECHA VENTA</label><input type="text" id="fecha" name="fecha" class="fechas" value="<?php echo date("d-m-Y");?>"/></td>
        <td><label>DESTINO</label><input type="text" id="destino" name="destino" style="text-transform:uppercase;"  /></td>
        <td >
               <label>MONEDA</label>
        ...
        <td >
               <label>CAMBIO</label>
<input type="text" name="cambio" id="cambio" size="3" readonly value="<?php echo $tc2["valor"]?>" />
        </td>
...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <td><label>NUMERO DE FACTURA</label>
                     <input type="TEXT" name="numfactura" style="text-transform:uppercase;"/>
                     </td>
                     
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="numingreso"   id="numingreso" style="text-transform:uppercase;"/>
                     </td>
                     <td>
                     <label>MONTO INGRESO</label>
                     <input type="TEXT" name="montoingreso" style="text-transform:uppercase;" class="validate[custom[number]]" />
                     </td>
                     <td>
                     <label>TIPO DE PAGO</label>
                     <select name="tipopago" id="tipopago">
                     ...
                     <TD>
                     <label>MONTO</label>
                     <input type="text"  name="adelanto" id="adelanto"  value="0"/>
                     
                    
                     </TD>
                     <td><label>NUMERO DE FACTURA</label>
                     <input type="TEXT" name="facturaadelanto" style="text-transform:uppercase;"/>
                     </td>
                    
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="reciboadelanto" style="text-transform:uppercase;"/>
                     </td>
                     ...
                     <td>
                     <label>BANCO-NUMERO DE CUENTA</label>
                     <input type="TEXT" name="cuentabancoadelanto"  size="50" id="cuentabancoadelanto"  />
                     </td>
           ...
           <fieldset id="tablacondiciones" style="display:none;"><legend>CONDICIONES DE  CREDITO</legend>
                     <table>
                     <TR>
                     <TD><label>Num.Cuotas</label><input  type="text" size="7" value="1" id="num_cuotas" name="num_cuotas"/>
                     
                     </TD>
                     <td><label>Dias de Pago</label>
                     <input type="text"  value="0" size="7"id="diaspago" name="diaspago" />
                    
                     
                     </td>
                     <td><label>Dias de Gracia</label>
                     <input type="text"  value="0" size="7"id="dias" name="dias"/>
                    
                     
                     </td>
                   
                      <td>
                     <input  type="button" value="Plan de Pagos"  id="bconsultar" name="btn_cuotas" onclick="verPlanPagos();" />
                     <input type="hidden" name="numfilascuotas" id="numfilascuotas" />
                     </td>
                            <TR>
                            <TD colspan="3">
                            <table >
                     ...
                     <TD>
                     <label>Monto total</label>
                     <input type="text"  readonly="readonly" id="totalventa" />
                     ...
                     <td>
                     <label>Descuento</label>
                     <input  type="text" id="descuentomonto" value="0" name="monto_descuento"/>
                     </td>
                    <td>
                     <label>Total   a cancelar</label>
                     <input  readonly="readonly"type="text" id="totalcancelar" name="totalcancelar" value="0"/>
                     </td>
                     </TR>
                     ...
                     <TD>
                     <label>Medio de Trasporte para el Despacho</label>
                     <input type="text"  name="transporte" size="55" style="text-transform:uppercase;"/>
                     
                    
                     </TD>
                     <td><label>OBSERVACIONES</label><textarea name="obs" cols="35" maxlength="255" id="obs" ></textarea></td>
