...
<input type="hidden" id="anio" name="anio"  value="<?php echo $anio;?>"  />
           ...
           <?php foreach($listaVendedores as $v){  ?>
               ...
               <td align="right"><?php  $res=$detalleVentas->sumarPorCodigo($r["codigo"],$mes,$anio,$v["idvendedores"]); $cantidad=$res["sumcantidad"]; echo $cantidad; $sum_cantidad+=$cantidad; ?></td>
           <?php }?>
           <td align="right"><?php  $s1+=$sum_cantidad; echo $sum_cantidad;?></td>
           <td align="right">
		   <?php
		    if($_POST["moneda"]=="Bs")
		   {
