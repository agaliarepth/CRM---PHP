...
<input type="hidden" id="anio" name="mes"  value="<?php echo $_POST["mes"];?>"  />
			 ...
			 <table  width="100%" id="registroVentas" cellpadding="0"  cellspacing="0"  >
             <thead>
             <tr >
             <th >FECHA</th>
             <th >NOTA<BR />EGR</th>
             <th width="50">NOMBRE<BR />VENDEDOR</th>
             <th>CLIENTE</th>
             <th >N&deg;VENTA</th>
             <th >CANT</th>
             <th  width="100">COD<BR />PROD</th>
			 ...
			 <td  width="150"><?php echo date("d/m/Y",strtotime($r["fecha"]));?></td>
             ...
             <td width="100" style="font-size:11px;" ><?php echo $r["vendedor"];?></td>
             <td width="250" style="font-size:11px;" ><?php  $nombre=$r["clientes_idclientes"];  $n=$cliente->getNombre($r["clientes_idclientes"]); echo utf8_decode($n["nombres"]." ".$n["apellidos"]);?></td>
             <td width="63" style="font-size:11px;"><a style="cursor:pointer; color:#03F" onClick="imprimir('<?php echo config::ruta();?>?accion=vernotaVenta&id=<?php echo $r["idventas"];?>');"><?php echo VENTA."-".helpers::rellenarCeros($r["idventas"],6);?></a></td>
             <td align="CENTER"><?php  echo $r["cantidad"]// echo number_format($r["cantidad"], 2); ?></td>
             <td ><?php echo $r["codigo"]?></td>
             <td style="font-size:11px;"><?php $tit=$libros->getCodigoTitulo($r["libros_idlibros"]); echo $tit["titulo"];?></td>
             <td align="right">
