...
$(document).ready(function() {
	 ...
	 var saldo=parseFloat($("#saldoinicial").html());
	  ordenar();
     ...
     $("#FormularioExportacion").submit();
	  ...
	  $("#kardexcliente-table thead").click(function(){
			
			 ordenar();
			});  
			
			$('#kardexcliente-table').dataTable( {
        "bPaginate": true,
		"oLanguage": {
...
function ordenar(){
	saldo=parseFloat($("#saldoinicial").html());

	 $('#kardexCliente tr').each(function () {
		  if($(this).find("td").eq(7).html()!=""){
			  
			  saldo=saldo+parseFloat($(this).find("td").eq(7).html());
			 saldo=redondeo(saldo,2);
			 var aux=formatNumber.new(saldo)
			  $(this).find("td").eq(9).html(formatNumber.new(saldo));
			  
			  }
			  if($(this).find("td").eq(8).html()!=""){
			  
			  saldo=saldo-parseFloat($(this).find("td").eq(8).html());
			saldo=redondeo(saldo,2);
			  $(this).find("td").eq(9).html(formatNumber.new(saldo));
	  ...
	  $("#saldoFinal").html(formatNumber.new(saldo,""));
	}
$(function() 
		{
...
<tr><td colspan="4">
         ...
         <td colspan="2">
          ...
          <TD  id="saldoinicial" align="right"><?php  echo $saldo_inicial?></TD>
          <TD></TD>
         <TD  align="right"><?php echo $saldo_inicial?></TD>
          ...
          <tr>
           ...
           <td><a href="####" onClick="imprimir('<?php echo config::ruta();?>?accion=vernotaVenta&id=<?php echo $r["idventas"];?>');"><?php echo "NV-".$r["idventas"]; ?></a></td>
		...
		<?PHP // FILA DE ADELANTOS
		  ...
		  <?php // FILA DE DEVOLUCIONES
           ...
           <td align="center">DEVOLUCION</td>
			 ...
			 <?php 
               ...
               <?php // FILA DE DEVOLUCIONES DINERO
			  foreach($listaDevolucionDinero as $r){
			  ?>
		  ...
		  <tr style="background-color:#09F;">
           ...
           <td ></td>
           <td align="right"><?php //echo $saldo_inicial-=$pt;  ?></td>
           <td align="center">DEVOLUCION DINERO</td>
         ...
         <td id="saldoFinal" align="right"><?php //echo $saldo_inicial;?></td>
         <td></td>
          </TR> 
