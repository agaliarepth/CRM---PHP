           ...
           <table border="0"  cellpadding="0" cellspacing="0" id="categorias-table" style="font-size:9px;">
				...
				?><tr>
					...
					<td style="font-weight:bold;"><?php echo $v["codigo"];?></td>
                                        ...
                                        <td width="500px"><?php echo $v["titulo"]?></td>
                    ...
                    <td   align="center" ><?php echo $ingreso->getStockActual($v["idlibros"])-$egreso->getStockActual($v["idlibros"]);?></td><?php } 
					else{?>
                     <td align="center"><?php echo $ingreso->getStockActual($v["idlibros"])-$egreso->getStockActual($v["idlibros"]);?></td><?php }?>
                    
                    <td align="center" ><?php echo $v["pv"]?></td>
