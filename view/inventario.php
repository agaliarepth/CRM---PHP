           ...
           <table border="0"   width="100%"cellpadding="0" cellspacing="0" id="inventario-table" >
               ...
               <tr >
                ...
                <td><?php echo utf8_decode($v["titulo"]);?></td>
                 <td  style="text-align:right" ><?php echo str_replace(",",".",$v["cif"]);?></td>
				...
				echo sprintf("%01.2f", str_replace(",",".",$ingreso_act));
				 ?>


                </td>
                <td  style="text-align:right">
                <?php $m1=$v["cif"]*$ingreso_act; echo  str_replace(",",".",$m1); sprintf("%01.2f",$m1); ?>
                 </td>
                  <td  style="text-align:right">
                <?php
                ...
                <td  style="text-align:right">
                <?php $m2=$v["cif"]*$egreso_act; echo  str_replace(",",".",$m2);?>
                 </td>
                 <td  style="text-align:right">
                 <?php $saldo_act=$saldo_ante+$ingreso_act-$egreso_act; echo $saldo_act;?>

                 </td>
                 <td  style="text-align:right"><?php $costo_ant=$saldo_ante*$v["cif"]; echo  str_replace(",",".",$costo_ant); ?></td>
                  <td  style="text-align:right"><?php $costo_act=$saldo_act*$v["cif"]; echo  str_replace(",",".",$costo_act);?></td>
				</tr>
				<?php }// fin
				?>
