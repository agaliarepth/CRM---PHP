<?php require_once("head.php");?>
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function($)
  {
	...
	/*  $("#dias").change(function(){
		var sumarDias=parseInt($(this).val());
			 ...
			 if($(this).val()=="monto"){
				...
				var r=parseFloat($("#totalventa").val()-$("#descuentomonto").val()).toFixed(2);
				 ...
				 if($(this).val()=="porcentaje"){
					 var aux=Math.round($("#descuentomonto").val())/100;
  ...
  foreach($res2 as $v){
	  ...
	  if($res["tipoventa"]=="CONTADO"){
		  ...
		  if($res["tipoventa"]=="CREDITO"){
			  ...
			  if($res["monto_descuento"]>0){
				  
				 echo" 
			
		 	  $('#tabladescuento').css({ display: 'block'});
		$('#totalventa').val(precio_total);
		$('#totalcancelar').val(".$res["monto_descuento"].")
...
?>
   ...
   {
    campo = '<tr ><td width="10px"><input type="text"  readonly ="readonly" size="10" id="codigo' + nextinput + '"  name="codigo[]' + nextinput + '" value="'+codigo+'"  /></td><td><input type="text"  readonly ="readonly"  size="70" id="titulo ' + nextinput + '"  name="titulo[]' + nextinput + '" value="'+titulo+'"  /></td><td><input type="text"  readonly ="readonly" size="5" id="tomo' + nextinput + '"  name="tomo[]' + nextinput + '" value="'+tomo+'" /></td><td ><input type="text"  size="5" id="cantidad' + nextinput + '"  name="cantidad[]' + nextinput + '"  value="'+cantidad+'" onchange="recalcularCantidad(this);" /></td><td  colspan="2"><input type="text" size="10" value="'+pu+'" id="precio_unit' + nextinput + '"  name="precio_unit[]" onchange="recalcularPrecio(this);"  /></td><td  ><input type="text"  readonly ="readonly" size="10" id="precio_total' + nextinput + '" value="'+pt+'"  name="precio_total[]' + nextinput + '"/></td><td><img src="images/eliminar.png  " width="25" height="25" alt="Eliminar"  id="boton' + nextinput + '" onclick="if(confirm(\'Realmente desea eliminar este detalle?\')){eliminarFila(this); }"/><input type="hidden"  id="idlibro' + nextinput + '"  name="idlibro[]' + nextinput + '" value="'+id+'"  /><input type="hidden"  id="disponible' + nextinput + '"  name="disponible[]' + nextinput + '" value="'+disponible+'"  /></td></tr>';
...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <td  ><input  size="5"  readonly="readonly" name="cant_total" class="inp2-form" id="cant_total"  /></td>
                     <TD colspan="2"></TD>
                        <td > <input name="monto_total" size="5"  class="inp2-form" readonly  id="monto_total" /></td>
                     ...
                     <input type="TEXT" name="numingreso" style="text-transform:uppercase;" value="<?php echo $cont["numingreso"]?>"/>
                     </td>
                     <td>
                     <label>MONTO INGRESO</label>
                     <input type="TEXT"   style="text-transform:uppercase;"value="<?php echo $cont["saldo"]?>"name="montoingreso" class="validate[custom[number]]"/>
                     </td>
                     <td>
           ...
           <fieldset id="tablacondiciones" style="display:none;"><legend>CONDICIONES DE  CREDITO</legend>
                     ...
                     <input type="text"  readonly="readonly" id="totalventa"  value="<?php echo $res["total"]?>" />
                     ...
                     <input  type="text" id="descuentomonto" name="monto_descuento" value="<?php  if($res["tipo_desc"]=="porcentaje"&&$res["monto_descuento"]>0 )echo (($res["total"]-$res["monto_descuento"])/$res["total"])*100; if($res["tipo_desc"]=="monto" &&$res["monto_descuento"]>0) echo $res["total"]-$res["monto_descuento"]; if($res["monto_descuento"]==0) echo "0"?>"/>
                     </td>
                     <td>
                     <label>Total   a cancelar</label>
                     <input  readonly="readonly"type="text" id="totalcancelar" name="totalcancelar" value="<?php echo $res["monto_descuento"]?>" />
                     </td>
                     </TR>
...
<table cellpadding="0"  width="70%" id="detalle" border="0" >
                    ...
                    <tfoot>
                     ...
                     <td>
                     <label>RECIBO DE INGRESO</label>
                     <input type="TEXT" name="numingreso" style="text-transform:uppercase;"/>
                     </td>
                     <td>
                     <label>MONTO INGRESO</label>
