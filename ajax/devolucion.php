...
$criterio = strtolower($_GET["term"]);
	    ...
	    $sql="SELECT cod_libro, idlibro,titulo_libro,tomo_libro, count(cod_libro) as disponible FROM kardexvendedor WHERE cod_libro LIKE :term  AND vendedores_idVendedores='".$_GET["id"]."' AND idalmacenes='".$_GET["idalmacen"]."' AND estado_libro='Remitido'";
